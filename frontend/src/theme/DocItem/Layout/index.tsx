/**
 * Swizzled DocItem/Layout component to integrate ChapterWrapper
 * This wraps all documentation pages with the personalization button
 */
      ...
      <div className={clsx('col', !docTOC.hidden && styles.docItemCol)}>
        ...
        <div className={styles.docItemContainer}>
          <article>
            ...
            {/* Wrap content with ChapterWrapper for personalization */}
